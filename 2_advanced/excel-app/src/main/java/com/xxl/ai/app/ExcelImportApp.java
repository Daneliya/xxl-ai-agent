...
public class ExcelImportApp {
     ...
     */
    public ExcelImportApp(ChatModel dashscopeChatModel) {
        // 初始化基于内存的对话记忆
...
//                        new ReReadingAdvisor()
     ...
     * @return
     */
    public ExcelAnalysisApp.LoveReport doChatWithReport(String message, String chatId) {
        ExcelAnalysisApp.LoveReport loveReport = chatClient
                .prompt()
                ...
                .advisors(spec -> spec.param(CHAT_MEMORY_CONVERSATION_ID_KEY, chatId)
                        .param(CHAT_MEMORY_RETRIEVE_SIZE_KEY, 10))
                .call()
                .entity(ExcelAnalysisApp.LoveReport.class);
